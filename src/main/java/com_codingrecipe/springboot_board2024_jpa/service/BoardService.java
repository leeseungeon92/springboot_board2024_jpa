...
import com_codingrecipe.springboot_board2024_jpa.repository.BoardFileRepository;
...
public class BoardService {
        ...
        if(boardDTO.getBoardFile().isEmpty()){
            ...
            */
            ...
            for (MultipartFile boardFile : boardDTO.getBoardFile()) {
                ...
                String savePath = "C:\\Users\\JJS\\Desktop\\jpa_test_folder" + storedFileName; // 4.
    ...
    public Page<BoardDTO> paging(Pageable pageable) {
        ...
        //한 페이지 당 3개의 글을 보여주고, 정렬 기준은 id 기준으로 내림차순
        ...
        Page<BoardDTO> boardDTOS = boardEntities.map(
                board ->
                        new BoardDTO(board.getId(), board.getBoardWriter(), board.getBoardTitle(), board.getBoardHits()));
